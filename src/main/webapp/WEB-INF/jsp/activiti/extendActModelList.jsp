    ...
    <div class="row" style="margin-top: 20px;">
        <form class="layui-form" id="search-from" action="${webRoot}/act/model/list">
            <div class="layui-form-item">
                <label class="layui-form-label" style="width:9%;">模型名称：</label>
...
<script>
   ...
   //     var url="${webRoot}/plugins/process/modeler.html?modelId="+modelId;
        var url="${webRoot}/plugins/activiti/modeler.html?modelId="+modelId;
        //弹框层
        layer.open({
            scrollbar: false,
            type: 2,
    ...
    function showFlowImg(modelId) {
        ...
        //url= '/resources/plugin/activiti/diagram-viewer/index.html?processDefinitionId=' + modelId

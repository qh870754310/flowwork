...
public class MD5 {
    ...
    public static String byteArrayToHexString(byte[] iIll) {
        StringBuffer illl1111I1I = new StringBuffer();
        for (int i11I = 0; i11I < iIll.length; i11I++) {
            illl1111I1I.append(byteArrayToHexString(iIll[i11I]));
        }
        return illl1111I1I.toString();
    }

    private static String byteArrayToHexString(byte iI1l) {
        int ilIl = iI1l;
        if (ilIl < 0)
            ilIl += 256;
        int iIII1 = ilIl / 16;

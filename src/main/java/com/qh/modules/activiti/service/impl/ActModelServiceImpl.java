...
import com.qh.modules.activiti.dao.ActExtendDao;
...
import com.qh.modules.activiti.entity.*;
...
import com.qh.modules.common.entity.TableInfo;
...
import com.qh.modules.common.utils.CodeUtils;
...
public class ActModelServiceImpl implements ActModelService {
        ...
        for (FlowElement flowElement : flowElements) {
            ...
            if (flowElement instanceof SequenceFlow) {
                ...
                if (sqlist != null && sqlist.size() > 0) {
                    SequenceFlow teml = sqlist.get(0);
                    pid = teml.getSourceRef();
                }
            }
    ...
    @Override
    public Page<UserEntity> turnWindowPage(int pageNum, UserEntity user) {
        PageHelper.startPage(pageNum,Constant.pageSize);
 ...
 /*   public void sendNoticeMsg(String userId,ExtendActBusinessEntity businessEntity){
    ...
    public void endFailFolw(ProcessTaskDto processTaskDto, Map<String, Object> map) throws Exception {
        ...
        //查询流程业务基本信息
        org.activiti.engine.task.Task task = taskService.createTaskQuery().taskId(processTaskDto.getTaskId()).singleResult();
        ExtendActNodesetEntity nodesetEntity = nodesetService.queryByNodeId(task.getTaskDefinitionKey());

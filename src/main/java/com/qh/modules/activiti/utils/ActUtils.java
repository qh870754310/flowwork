package com.qh.modules.activiti.utils;
...
public class ActUtils {
     ...
     * @throws Exception
     */
    public static void setMultiInstance(String modelId, String nodeId) throws Exception {
        //获取模型
     ...
     * @throws Exception
     */
    public static void clearMultiInstance(String modelId,String nodeId) throws Exception{
        //获取模型
        byte[] mes = repositoryService.getModelEditorSource(modelId);
        //转换成JsonNode
     ...
     */
    public static void setSequenceFlowCondition(String modelId,String nodeId ,String condition) throws IOException {
        //获取模型--设置连线条件 到 流程中
